    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardNotes", x => new { x.DoctorId, x.CardId, x.AppointmentId });
                    table.ForeignKey(
                        name: "FK_CardNotes_Appointments_AppointmentId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardNotes_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Doctors",
                columns: new[] { "Id", "Doctor_Position", "Full_Name" },
                values: new object[,]
                {
                    { 1, "Pediatr", "First Doctor" },
                    { 2, "Surgeon", "Second Doctor" },
                    { 3, "Lor", "Third Doctor" },
                    { 4, "Pediatr", "Fourth Doctor" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardNotes_AppointmentId",
                table: "CardNotes",
